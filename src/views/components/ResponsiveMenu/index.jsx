...
const ResponsiveMenu = ({ theme, onThemeChange }) => {
  ...
  const handleChangeTheme = useCallback((_, theme) => onThemeChange(theme), [onThemeChange]);
  return (
    <>
      <Box sx={{
        ...
        <Button disabled onClick={navigateToAbout}>About</Button>
        <Button disabled onClick={navigateToResources}>Resources</Button>
        <Button disabled onClick={navigateToContact}>Contact</Button>
        <ToggleButtonGroup
          color="primary"
          value={theme}
          exclusive
        ...
        >
          <ToggleButton value="kiddy" size="small">Kiddy</ToggleButton>
          <ToggleButton value="cyber" size="small">Cyber</ToggleButton>
        </ToggleButtonGroup>
      </Box>
      <Box sx={{
