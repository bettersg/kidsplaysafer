...
const AboutPanel = ({ onPrevious, onNext }) => (
  <ResponsivePanel small>
    ...
    <Box mb={RESPONSIVE_PANEL_SPACING}>
      ...
      <Box mb={RESPONSIVE_PANEL_SPACING}>
        <Typography align="justify">
          Both you (the parent) and your child will each answer the same list of
          questions. There is no right or wrong answer. Instead, the goal is to
          spark a conversation on online safety, bridge any knowledge gaps and
          foster closer family bonds.
        </Typography>
      </Box>
      <Box mb={RESPONSIVE_PANEL_SPACING}>
        <Typography align="justify">
